        ...
        if(isset($request['submit'])){
            ...
            if($journal_title == ""){
                ...
                if($instruction == ""){
                    ...
                    if($grade_id == ""){
                        echo "<p class='alert-danger'>Please select Grade!</p>";
                    }else{
                        if($start_date == ""){
                            ...
                            if($end_date == ""){
                                ...
                                $fourth_sql = "SELECT * FROM journal WHERE grade_id=:grade_id";
                                $fourth_stmt = $this->con->prepare($fourth_sql);
                                $fourth_stmt->bindParam("grade_id", $grade_id, PDO::PARAM_INT);
                                $fourth_stmt->execute();
                                $isset_journal = $fourth_stmt->fetchAll(PDO::FETCH_OBJ);

                                if(count($isset_journal) > 0){
                                    ...
                                    if(!$date_status){
                                        ...
                                        $sql = "INSERT INTO journal (journal_title, instruction, grade_id, user_id, start_date, end_date) VALUES (:journal_title, :instruction, :grade_id, :user_id, :start_date, :end_date)";
                                        $stmt = $this->con->prepare($sql);
                                        ...
                                        $sec_sql = "SELECT id FROM journal WHERE journal_title=:journal_title AND instruction=:instruction AND grade_id=:grade_id AND user_id=:user_id AND start_date=:start_date AND end_date=:end_date";
                                        $sec_stmt = $this->con->prepare($sec_sql);
                                        $sec_stmt->bindParam("journal_title", $journal_title, PDO::PARAM_STR);
                                        ...
                                        $sec_stmt->execute();
                                        $journal_res = $sec_stmt->fetch(PDO::FETCH_OBJ);
                                        ...
                                        $third_stmt->bindParam("name", $journal_title, PDO::PARAM_STR);
                                    ...
                                    if(!$date_status){
                                        ...
                                        if($start_date == $fourth_res->start_date){
                                            if($end_date == $fourth_res->end_date){
                                                ...
                                                $quize_id = null;
                                                $assignment_id = null;
                                                $sec_sql = "UPDATE queue SET name=:name, grade_id=:grade_id, start_date=:start_date, end_date=:end_date, quize_id=:quize_id, assignment_id=:assignment_id WHERE journal_id=:journal_id";
                                                $sec_stmt = $this->con->prepare($sec_sql);
                                                $sec_stmt->bindParam("name", $journal_title, PDO::PARAM_STR);
                                                $sec_stmt->bindParam("grade_id", $grade_id, PDO::PARAM_INT);
                                                $sec_stmt->bindParam("start_date", $start_date, PDO::PARAM_STR);
                                                $sec_stmt->bindParam("end_date", $end_date, PDO::PARAM_STR);
                                                $sec_stmt->bindParam("quize_id", $quize_id, PDO::PARAM_INT);
                                                $sec_stmt->bindParam("assignment_id", $assignment_id, PDO::PARAM_INT);
                                                $sec_stmt->bindParam("journal_id", $id, PDO::PARAM_INT);
                                                $sec_stmt->execute();
                                                return true;
                                            }
                                        }else{
