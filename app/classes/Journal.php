                                    ...
                                    if($end_date == ""){
                                        ...
                                        if(count($isset_journal) > 0){
                                            ...
                                            if(!$date_status){
                                                ...
                                                $sec_sql = "SELECT id FROM journal WHERE journal_title=:journal_title AND instruction=:instruction AND grade_id=:grade_id AND user_id=:user_id AND start_date=:start_date AND end_date=:end_date AND pdf=:file";
                                                ...
                                                $sec_stmt->bindParam('file', $file_name, PDO::PARAM_STR);
                                                $sec_stmt->execute();
